...
REPORT_TXT = REPORT_DIR / "PAI6_deep_diver_report.txt"
REPORT_JSON = REPORT_DIR / "PAI6_deep_diver_report.json"
...
f.write("🚀 PAI6 DEEP DIVER MASTER REPORT\n\n")
f.write(f"Root: {ROOT}\n\n")
...
print("\n✅ Deep Diver Scan Completed Successfully")
