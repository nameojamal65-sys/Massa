...
echo "📦 تحديث وإعداد Termux..."
pkg update -y
pkg upgrade -y
pkg install -y python git net-tools curl wget nano

echo "📦 تحديث pip..."
pip install --upgrade pip setuptools wheel

echo "📦 تثبيت حزم Python المطلوبة..."
pip install fastapi uvicorn psutil aiosqlite websockets
...
# ================= الحالة النهائية =================
echo "🔥 Legendary v6 FullStack Wi-Fi Jump Ready"
echo "Backend (Local): http://127.0.0.1:$PORT"
echo "Frontend (Local): http://127.0.0.1:$FRONT_PORT"
echo "Backend (LAN): http://$LOCAL_IP:$PORT"
echo "Frontend (LAN): http://$LOCAL_IP:$FRONT_PORT"
echo "=============================="
