#!/usr/bin/env python3
"""
🚀 PAI6 Deep Diver Fusion
---------------------------------
- فحص شامل لكل الملفات الأساسية
- استخراج الدوال والكلاسات ونقاط الدخول
- جمع Imports واستدعاءات النظام
- توليد تقارير TXT و JSON
- حساب Cohesion Index شامل
"""
...
REPORT_TXT = REPORT_DIR / "PAI6_deep_diver_fusion_report.txt"
REPORT_JSON = REPORT_DIR / "PAI6_deep_diver_fusion_report.json"
...
# -----------------------------
# 5️⃣ الحساب النهائي Cohesion Index
# -----------------------------
...
f.write("🚀 PAI6 Deep Diver Fusion Report\n\n")
f.write(f"Root: {ROOT}\n\n")
...
print("\n✅ Deep Diver Fusion Completed Successfully")
