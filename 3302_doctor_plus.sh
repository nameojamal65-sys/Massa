...
# =====================================================
# Doctor 1-on-1 Plus: تشغيل وفحص منظومة السكربتات تلقائياً
# =====================================================
...
echo "🚀 Doctor 1-on-1 Plus بدء التشغيل..."
echo "==================================="
...
run_scripts_in_dir() {
    ...
    for FILE in "$DIR"/*; do
        ...
        if [ $? -eq 0 ]; then
            ...
            log "$NAME ❌ فشل في التشغيل (تم التجاهل واستمرار التشغيل)"
        fi
    done
}

# --- تنفيذ ---
log "بدء فحص وتشغيل المنظومة تلقائياً..."

run_scripts_in_dir "$CORE_DIR"
run_scripts_in_dir "$MODULES_DIR"

log "✅ انتهاء Doctor 1-on-1 Plus: كل السكربتات تمت مراجعتها وتشغيلها."
echo "==================================="
